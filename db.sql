...
-- Date: Sat, 31 Aug 2019 12:35:14 +0700
...
SET autocommit=0;
INSERT INTO `kabupaten` VALUES (1801,4,'KABUPATEN LAMPUNG BARAT'),(1802,4,'KABUPATEN TANGGAMUS'),(1803,1,'LAMPUNG SELATAN'),(1804,8,'LAMPUNG TIMUR'),(1805,7,'LAMPUNG TENGAH'),(1806,5,'LAMPUNG UTARA'),(1807,5,'WAY KANAN'),(1808,6,'TULANGBAWANG'),(1809,3,'PESAWARAN'),(1810,3,'PRINGSEWU'),(1811,6,'MESUJI'),(1812,6,'TULANG BAWANG BARAT'),(1813,4,'PESISIR BARAT'),(1871,2,'BANDAR LAMPUNG'),(1872,3,'METRO'),(1876,124,'test aja');
/*!40000 ALTER TABLE `kabupaten` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `kabupaten` with 16 row(s)
--
...
) ENGINE=InnoDB AUTO_INCREMENT=1872024 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on: Sat, 31 Aug 2019 12:35:14 +0700
