	...
	<div class="col-md-12">
		...
		<div class="{{$class}}">
			...
			<div data-toggle="tooltip" title="{{$message}}">
				{!! Form::select(ADHhelper::displayIdKandidat($pemilihan->tipe),ADHhelper::getSelectKandidat($pemilihan->tipe, $pemilihan->periode),null,['class'=> 'form-control select2','placeholder'=>'Pilih ' . ADHhelper::displayKandidat($pemilihan->tipe),'id'=>ADHhelper::displayIdKandidat($pemilihan->tipe)]) !!}
			</div>
		</div>
